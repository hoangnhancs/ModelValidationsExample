...
namespace ModelValidationsExample.CustomModelBinders
{
    public class PersonModelBinder : IModelBinder
    {
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            //{
            //    person.PersonName =String.Join(person.PersonName," ",bindingContext.ValueProvider.GetValue("LastName").FirstValue);
            //}
            person.PersonName = String.Join(" ", bindingContext.ValueProvider.GetValue("FirstName").FirstValue,                                                    bindingContext.ValueProvider.GetValue("LastName").FirstValue);
